...
def about():
    content = '<div dir="ltr" style="text-align: left;" trbidi="on">\n' \
              ...
              'href="http://papersaround.blogspot.com/p/statistic.html">statistics</a>, containing the most interesting ' \
              'information about these newspapers. I thank all the <a style="text-decoration: underline" ' \
              'href="http://papersaround.blogspot.com/p/senders.html">people</a> who send newspapers for this site, ' \
              'because only through them, there is the opportunity to work with many elements of culture of peoples from ' \
              'different parts of the globe. All sended newspapers are read with interest, carefully scanned, stored and ' \
              'exhibited for public viewing and inspiration.</p>\n' \
              '    <hr noshade style="margin-top: 30px; margin-bottom: 30px; color: black; background-color: black; height: ' \
              '1px; border: none">\n' \
              '    <p>From the author:</p>\n' \
              ...
              'href="http://papersaround.blogspot.com/search/label/Russia">Russia</a>, <a style="text-decoration: underline" ' \
              'href="http://papersaround.blogspot.com/search/label/Yekaterinburg">Yekaterinburg</a> and, concurrently, ' \
              'leading this site. In the summer of 2013, my younger sister, <a style="text-decoration: underline" ' \
              ...
              'href="http://papersaround.blogspot.com/2012/01/beijing-china.html">newspaper</a>, which had previously ' \
              'served as packaging for goods from <a style="text-decoration: underline" ' \
              'href="http://papersaround.blogspot.com/search/label/China">China</a>. Sister could not resist and brought ' \
              'this tiny piece of another culture to home. A little later, she thought that the newspapers with their ' \
              'unique language, typography, images, and design are ideal for collectors who dream of distant travels. ' \
              'Then I improved her idea and created this site.</p>\n' \
              '    <p>If you want to help this site by sending the newspaper from his native Louisiana or from a trip to ' \
              'the deserts of Africa or you have any suggestions / advice you can send letters and parcel to the address:</p>\n' \
              '    <!--Костыли для английского и русского адресов, по-хорошему нужно писать не так, а выносить это всё в ' \
              'отдельные файлы-->\n' \
              '    <style>\n' \
              ...
              '    <p>or to <a style="text-decoration: underline" href="mailto:b.ovodov@gmail.com">b.ovodov@gmail.com</a>.</p>\n' \
              '</div>'
